    ...
    <OuterWrapper>
      {isOpen && <MenuBackground>
        <LinksWrapper>
            ...
            <LinkWrapper onClick={() => setIsOpen(!isOpen)}><StyledExternalLink href="https://www.instagram.com/pandemicpregnancyguide/channel/" target="_blank">Videos</StyledExternalLink></LinkWrapper>
